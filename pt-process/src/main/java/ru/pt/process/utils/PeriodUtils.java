...
public class PeriodUtils {
    ...
    public static boolean isDateInRange(ZonedDateTime date1, ZonedDateTime date2, String range) {
        ...
        ZonedDateTime minDate = date1.plus(minPeriod);
        ZonedDateTime maxDate = date1.plus(maxPeriod);
